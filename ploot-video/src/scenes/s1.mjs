...
export const CARDS1 = [
  { id: "m", p: PEOPLE.marta,  s: "Está visitando tu web",                 x: 700,  y: 450, rot: -7, depth: 1 },
  { id: "d", p: PEOPLE.daniel, s: "Ha compartido tu contenido en LinkedIn", x: 1480, y: 70,  rot: -8, depth: 1 },
  { id: "a", p: PEOPLE.lucia,  s: "Ha vuelto a tu web",                     x: -150, y: 110, rot: -7, depth: 1 },
  { id: "b", p: PEOPLE.pablo,  s: "Ha visto tu perfil",                     x: 640,  y: -20, rot: -8, depth: 0.82 },
  { id: "c", p: PEOPLE.elena,  s: "Ha abierto tu caso de cliente",          x: 1560, y: 520, rot: -7, depth: 1 },
  { id: "e", p: PEOPLE.ivan,   s: "Compara precios",                        x: -130, y: 560, rot: -8, depth: 1 },
  { id: "f", p: PEOPLE.nuria,  s: "Ha descargado tu caso",                  x: 220,  y: 900, rot: -7, depth: 0.85 },
  { id: "g", p: PEOPLE.hugo,   s: "Busca tu solución",                      x: 1380, y: 890, rot: -8, depth: 0.82 },
];
...
export const html = `
<!-- P2: Ahora mismo (magnético) + dos luces desde las esquinas → web 3D + cursores + push-in -->
<div id="s1-p2" class="phase bg-dark grid-dark">
  ...
  ${kin("s1-t1", "Ahora mismo", { pos: "center", color: "white", size: 112 })}
  <div id="s1-cam2" class="cam" style="transform-origin:960px 790px">
    ...
    ${vcursor("s1-v1", "Visitante · Madrid", "#2d5bff", { x: 760, y: 690 })}
    ${vcursor("s1-v2", "Visitante · Bilbao", "#7c5cff", { x: 1150, y: 700 })}
    ${vcursor("s1-v3", "Visitante · Sevilla", "#1fa463", { x: 900, y: 860 })}
  </div>
  ${kin("s1-t2", "Hay personas decidiendo comprar", { color: "white" }).replace('<div id="s1-t2"', '<div id="s1-t2" data-layout-allow-overlap')}
</div>

<!-- P3: naranja -->
<div id="s1-p3" class="phase bg-orange">
  ${kin("s1-t3", "Justo lo que tú vendes", { pos: "center", color: "white" })}
</div>
...
<div id="s1-p4" class="phase bg-light grid-light">
  ...
  ${kin("s1-t4a", "Entran a tu web")}
  ${kin("s1-t4b", "Leen tu contenido")}
</div>
...
<div id="s1-p5" class="phase bg-light">
  ...
  <div id="s1-webs" class="layer">
    <div class="stage">
      <div id="s1-webs-g" class="p3d" style="left:0;top:0;width:1920px;height:1080px">
        ...
        <div id="s1-w-a" class="webwrap" style="left:720px;top:306px;width:480px;height:465px;--s:.75">${webCompetitor("s1-w-a-web", "Competidor A")}</div>
        <div id="s1-w-b" class="webwrap" style="left:1280px;top:306px;width:480px;height:465px;--s:.75">${webCompetitor("s1-w-b-web", "Competidor B")}</div>
        <div class="wlabel" id="s1-wl-me" style="left:160px;top:262px">Tu web</div>
        <div class="wlabel" id="s1-wl-a" style="left:720px;top:262px">Competidor A</div>
        <div class="wlabel" id="s1-wl-b" style="left:1280px;top:262px">Competidor B</div>
      </div>
    </div>
    ${trails}
    ${vcursor("s1-u1", "Visitante · Madrid", "#2d5bff", { x: 400, y: 600 })}
    ${vcursor("s1-u2", "Visitante · Bilbao", "#7c5cff", { x: 960, y: 480 })}
    ${vcursor("s1-u3", "Visitante · Sevilla", "#1fa463", { x: 1520, y: 520 })}
  </div>
  ...
  ${label("s1-t5a", "Te comparan")}
  ${kin("s1-t5b", "Estás perdiendo mucho dinero", { pos: "center", size: 92 })}
</div>

<!-- P6: contador mecánico + Sin enterarte -->
<div id="s1-p6" class="phase bg-orange">
  ${kin("s1-t6", "Sin enterarte", { pos: "center", color: "white", size: 100 })}
</div>
`;
