...
<div id="s6-p1" class="phase bg-dark">
  ${kin("s6-intro", "That’s why we built", {color:"white",size:60})}
  ...
  ${wordmark}
  ${kin("s6-t1", "A new go-to-market system", { pos: "center", size: 88 })}
</div>
...
<div id="s6-p2" class="phase bg-light grid-light">
  ...
  ${label("s6-t2", "That turns your team")}
  <div id="s6-halo" class="halo"></div>
  ${kin("s6-t3", "Into your best sales channel", { pos: "center", size: 84 })}
</div>
`;
